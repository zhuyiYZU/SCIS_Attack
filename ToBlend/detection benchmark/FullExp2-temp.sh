...
exp_path=../datasets/
data_path=$exp_path/full-dataset-ensemble-len
res_path=$exp_path/full-dataset-ensemble-len/results
res_path_baseline=$exp_path/full-dataset-ensemble/results-baseline
