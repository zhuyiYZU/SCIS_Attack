...
#     python scripts/data_builder.py --dataset $D --n_samples 500 --base_model_name $M --output_file $data_path/${D}_${M} --cache_dir /home/fanhuan/cache
#   done
# done
...
#                           --dataset_file $data_path/${D}_${M}.t5-3b.perturbation_100 --output_file $res_path/${D}_${M}  --cache_dir /home/fanhuan/cache
#   done
# done
...
#                           --dataset_file $data_path/${D}_${M} --output_file $res_path/${D}_${M}.${M1}_${M2}  --cache_dir /home/fanhuan/cache
#     done
#   done
# done
...
#                           --dataset_file $data_path/${D}_${M}.${M1}.perturbation_100 --output_file $res_path/${D}_${M}.${M1}_${M2}  --cache_dir /home/fanhuan/cache
#     done
#   done
# done
